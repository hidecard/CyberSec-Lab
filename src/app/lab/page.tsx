...
import { AlertTriangle, Search, ArrowLeft, BookOpen, Bug, Eye, Target, Globe, Users, FileText, Package, Key, BarChart, Database, TerminalSquare, Code2, Zap, Link, Award, Lock } from 'lucide-react'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-slate-600 text-sm font-medium">Lab Active</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-12 sm:mb-16 px-4 sm:px-0">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 mb-6 sm:mb-8 text-center sm:text-left">Security Labs</h3>
